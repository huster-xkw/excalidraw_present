...
export interface AppState {
  ...
  /** multi-page / slides support */
  currentPageId: string;
  pages: readonly Page[];
  /** direction of the page-flip animation, null when idle */
  pageFlipDirection: "forward" | "backward" | null;

  /** prompter notes by page id */
  prompterTextByPage: Record<string, string>;
}
